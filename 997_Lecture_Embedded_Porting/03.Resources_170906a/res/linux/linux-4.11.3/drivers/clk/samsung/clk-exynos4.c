...
#if 0 /* org */
#else /* James Kim 170610: move to the right place */
	{
		unsigned char *p = reg_base; 
		//printk("CLK_SRC_LCD=%08X\n", *(unsigned int *)(p+0xc234));
		//printk("CLK_DIV_LCD=%08X\n", *(unsigned int *)(p+0xc534));
		//printk("CLK_GATE_IP_LCD=%08X\n", *(unsigned int *)(p+0xc934));
		*(unsigned int *)(p+0xc234) = 0x00001116;
		*(unsigned int *)(p+0xc534) = 0x00FFFFF4;
		*(unsigned int *)(p+0xc934) = 0xFFFFFFD1;
		//printk("CLK_SRC_LCD=%08X\n", *(unsigned int *)(p+0xc234));
		//printk("CLK_DIV_LCD=%08X\n", *(unsigned int *)(p+0xc534));
		//printk("CLK_GATE_IP_LCD=%08X\n", *(unsigned int *)(p+0xc934));
	}
...
#if 0 /* org */
#else /* James Kim 170610: need to check more */
	{
		unsigned char *p = reg_base;
		//printk("CLK_SRC_MAUDIO=%08X\n", *(unsigned int *)(p+0xc23c));
		*(unsigned int *)(p+0xc23c) = 0x00000007;
		//printk("CLK_SRC_MAUDIO=%08X\n", *(unsigned int *)(p+0xc23c));
	}

	{
		unsigned char *p = ioremap(0x03810000, 0x10);
		//printk("ASS_CLK_SRC=%08X\n", *(unsigned int *)(p+0x0000));
		//printk("ASS_CLK_DIV=%08X\n", *(unsigned int *)(p+0x0004));
		//printk("ASS_CLK_GATE=%08X\n", *(unsigned int *)(p+0x0008));
		*(unsigned int *)(p+0x0000) = 0x00000001;
		*(unsigned int *)(p+0x0004) = 0x00000010;
		*(unsigned int *)(p+0x0008) = 0x0000004E;
		//printk("ASS_CLK_SRC=%08X\n", *(unsigned int *)(p+0x0000));
		//printk("ASS_CLK_DIV=%08X\n", *(unsigned int *)(p+0x0004));
		//printk("ASS_CLK_GATE=%08X\n", *(unsigned int *)(p+0x0008));
		iounmap(p);
